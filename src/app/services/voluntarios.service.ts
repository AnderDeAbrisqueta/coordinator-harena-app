...
export class VoluntariosService {
  ...
  saveVoluntario(voluntario: Voluntarios) {
    if (voluntario.id == undefined) {
      voluntario.id = this.voluntarioCounter++;
  ...
  // async saveVoluntario(voluntario: Voluntarios) {
  //   if (voluntario.id == undefined) {
  //     voluntario.id = this.voluntarioCounter++;
  //     this.voluntarios.push(voluntario);
  //   } else {
  //     this.deleteVoluntarioMayor(voluntario.id);
  //     this.voluntarios.push(voluntario);
  //   }
  //   await this.saveAdultosMayoresIntoStorage();
  //   await this.saveAdultoCounterIntoStorage();
  // }

  public deleteVoluntario(id: number) {
